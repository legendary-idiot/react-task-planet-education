...
const TestimonialCard = ({ t }) => (
  <div className="relative shrink-0 w-[280px] sm:w-[320px] md:w-[360px] lg:w-[380px] aspect-[3/4] rotate-[13deg] border-2 border-[#E018E0] overflow-hidden hover:rotate-0 hover:scale-90 hover:cursor-pointer transform-gpu transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]">
    <img
      src={t.image}
      alt={t.nameMeta}
